...
export function ProfileView() {
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2 rounded-xl bg-db-dark/5 p-1.5 dark:bg-white/5" role="tablist" aria-label="Demo-Sammlung">
...
function EmptyCollection({ icon: Icon, title, text }) {
  return (
    <div className="rounded-xl border border-dashed border-db-dark/15 bg-white py-14 text-center dark:border-white/15 dark:bg-db-dark/50" role="tabpanel">
