      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="max-h-[92vh] w-full max-w-lg overflow-y-auto rounded-xl border border-db-dark/10 bg-white p-6 shadow-2xl dark:border-white/10 dark:bg-db-dark"
          >
            <div className="flex items-start justify-between gap-4 border-b border-db-dark/10 pb-4 dark:border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs font-semibold text-db-rail dark:text-white/60">Nur verifizierte öffentliche Notrufnummern.</p>
                </div>
              </div>
              <button type="button" onClick={onClose} className="rounded-full p-2 text-db-dark hover:bg-db-dark/5 dark:text-white dark:hover:bg-white/10" aria-label="Notfallfenster schließen">
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <div className="mt-6 space-y-6">
              ...
              <section className="border-t border-db-dark/10 pt-5 dark:border-white/10">
                ...
                <div className="mt-3 space-y-3">
                  <a href="tel:08001110111" className="flex items-center justify-between rounded-xl border border-db-dark/10 bg-db-soft p-4 transition hover:border-db-red dark:border-white/10 dark:bg-db-dark/50">
                    <div>
                    ...
                    <PhoneCall className="h-5 w-5 text-db-red" />
                  </a>
