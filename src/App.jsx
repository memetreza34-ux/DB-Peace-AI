...
import { modusGewaehlt } from "./lib/geraet.js";
...
export default function App() {
  ...
  // Beim allerersten Start fragt AppLock nach dem Gerätemodus. Danach ist die
  // App offen — eine PIN gibt es seit dem 6.9.2026 nicht mehr, siehe AppLock.
  const [isLocked, setIsLocked] = useState(() => !modusGewaehlt());
